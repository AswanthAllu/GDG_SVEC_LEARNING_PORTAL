...
export const courses = [
  {
    ...
    "episodes": [
      ...
      {
        "id": 5,
        "title": "Introduction to Web Design: Mastering HTML Tags and CSS Styling",
        "desc": "How to use tags like img and span alongside CSS properties to build and style a functional, logic-driven quiz.",
        "videoUrl": "https://mega.nz/embed/7aZxzaaK#kZPKO6SR9wLkt43kTFqadwMvNm7TAcVjAT0jAUtVMeA",
        "quiz": [
          {
  ...
  },
  {
    ...
    "episodes": [
      ...
      {
        "id": 4,
        "title": "Build Responsive Layout using Flexbox",
        "desc": "Master Flexbox responsive layout with practical quiz.",
        "videoUrl": "https://mega.nz/embed/W0Z20YAB#lJBxDyV1g-evKxuy13Rtq3313RTjfWhJXwJ-q5Kl_90",
        "quiz": [
          {
            "question": "1. Which CSS property is used to enable Flexbox on a container?",
            "options": ["display: block", "display: flex", "display: grid", "display: inline"],
            "answer": "display: flex"
          },
          {
            "question": "2. What is the default value of the 'flex-direction' property?",
            "options": ["column", "column-reverse", "row", "row-reverse"],
            "answer": "row"
          },
          {
            "question": "3. Which property controls how flex items wrap onto multiple lines?",
            "options": ["flex-flow", "flex-wrap", "flex-shrink", "align-content"],
            "answer": "flex-wrap"
          },
          {
            "question": "4. Which property aligns flex items along the MAIN axis?",
            "options": ["align-items", "align-self", "justify-content", "align-content"],
            "answer": "justify-content"
          },
          {
            "question": "5. Which property aligns flex items along the CROSS axis?",
            "options": ["justify-content", "justify-items", "align-items", "flex-direction"],
            "answer": "align-items"
          },
          {
          ...
          {
            "question": "8. What is shorthand for flex-direction + flex-wrap?",
            "options": ["flex-layout", "flex-combined", "flex-flow", "flex-axis"],
            "answer": "flex-flow"
          },
          {
            "question": "9. Which property overrides align-items for a single item?",
            "options": ["align-content", "align-self", "justify-self", "self-align"],
            "answer": "align-self"
          },
          {
